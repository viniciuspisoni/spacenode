  ...
  return (
    <html lang="pt-BR" className={geist.variable} suppressHydrationWarning>
      ...
      <body className="antialiased">
        {/* Captura first-party: id anônimo (sn_aid, sempre) + UTMs/click-ids
            em cookie quando a URL traz parâmetros de campanha. Sem terceiros. */}
        <UtmCapture />
        <ThemeProvider>{children}</ThemeProvider>
        <GoogleTag />
        {/* GA4/Meta Pixel opcionais — nada renderiza sem env var (docs/ANALYTICS.md) */}
        <MarketingPixels />
      </body>
    </html>
  );
