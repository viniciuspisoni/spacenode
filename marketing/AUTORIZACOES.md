...
|---|---|---|---|---|---|---|
| muda arquitetura | **`muda arquitetura`** (minúsculo — é a marca) | cozinha-ceramica, hall-entrada | ✅ | ❓ | ⚠️ | aceite registrado em `components/landing/Projects.tsx` (main, 2026-09-09); mídia paga liberada pelo dono em 2026-09-16 (ver ressalva abaixo) |
